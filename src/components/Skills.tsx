                ...
                {categories.map((category, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="bg-zinc-950 border border-zinc-800 p-8 rounded-3xl hover:border-zinc-700 transition-all duration-300 flex flex-col justify-between group"
                        >
                            <div>
                                <div className="flex items-center gap-3.5 mb-6">
                                    <div className="p-3 rounded-2xl bg-zinc-900 border border-zinc-800 text-white group-hover:bg-white group-hover:text-black transition-colors">
                                ...
                                <div className="flex flex-wrap gap-2 pt-1">
                                    {category.skills.map((skill, idx) => (
                                        <span 
                                            key={idx} 
                                            className="px-3.5 py-2 bg-zinc-900 text-zinc-300 border border-zinc-800 rounded-xl text-xs font-mono tracking-wider hover:border-zinc-600 hover:text-white transition-all"
                                        >
                                            {skill}
                                        </span>
                                    ))}
